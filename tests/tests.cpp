...
LinkedCellContainer particles = LinkedCellContainer({20, 20, 1}, 3, {"o", "o", "o", "o", "o", "o"}, true, 1.5);
double sig = 1;
double eps = 5;
double cutoff = 3;
...
particles.addParticle({ 5, 6, 0}, { 0, 0, 0}, 50, 0, 1, 5);
particles.addParticle({ 5, 8, 0}, { 0, 0, 0}, 50, 0, 1, 5);
